  ...
  _renderContent = section => { //section for content of the accordion package
    return (
      <View style={styles.items}>
        ...
        }} buttonStyle={{borderColor: '#e84a4a', borderTopWidth: 1.5, marginRight: 20, marginBottom: 5}} title="Edit Device Settings" type="outline" titleStyle={{fontSize: 23, color: '#ff0000'}}
